...
const ColleagueLayout = () => {
  ...
  const menuItems = [
    { title: "Dashboard", url: "/colleague/dashboard", icon: LayoutDashboard },
    { title: "Requests", url: "/colleague/requests", icon: ClipboardList },
    { title: "Logs", url: "/colleague/logs", icon: FileText },
    { title: "Profile", url: "/colleague/profile", icon: User },
    { title: "Support / Help", url: "/colleague/support", icon: HelpCircle },
  ];
  ...
  return (
    <div className="h-screen flex w-full bg-gradient-to-br from-gray-50 via-white to-red-50/10 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col">
        {/* Header */}
        <header className="sticky top-0 z-50 h-14 md:h-16 border-b border-slate-200/60 bg-white/95 backdrop-blur-xl shadow-sm flex items-center px-3 sm:px-4 md:px-6 gap-2 sm:gap-4">
          {/* Mobile menu toggle */}
          ...
          <div className="flex-1">
            ...
            <p className="text-xs md:text-sm text-muted-foreground hidden sm:block">
              Submit maintenance requests and report incidents
            </p>
          </div>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem asChild>
                  <NavLink to="/colleague/profile" className="cursor-pointer">
